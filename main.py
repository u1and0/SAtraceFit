...
print('<使い方>')
print('グラフ化したいファイルベースネーム(拡張子抜きのファイル名)を入力')
print('ワイルドカードも使えます！')
print('"*"0文字以上の文字列')
print('"?"1文字か0文字の文字列')
print('"[]"の中に書いた文字列一文字ずつ(たとえば[135]は"1か3か5", [2-8]は"2,3,4,5,6,7,8のどれか")')
print('使える正規表現一覧: http://docs.python.jp/3/library/re.html')
print('(例)20151201_000344	<<<2015/12/01 00:03:44のデータ')
...
print('(例)201601??_21*		<<<2016年1月??日のデータのうち、21時台のデータ')
print('(例)*1201_19??56		<<<？年12月1日のデータのうち、19時台で56秒で終わっているデータ')
print('(例)201601??_2[13]*	<<<2016年01月のデータのうち、21時台か23時台のデータ')
